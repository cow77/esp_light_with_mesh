        ...
        for(idx=0;idx<fifo_len;idx++) {
            ...
            switch(d_tmp){
				...
				case 'b':
					...
					os_printf("connect to wifi\r\n");
					user_esp_platform_set_token("0123456789012345678901234567890123456789");
					WIFI_Connect("ESP_TEST","00000000",NULL);
					_LINE_DESP();
					break;
				case 'c':
					//wifi_station_disconnect();
				...
				case 'd':
					...
					os_printf("connect to wifi\r\n");
					user_esp_platform_set_token("0123456789012345678901234567890123456789");
					WIFI_Connect("TP-LINK_3E392E","19881215",wifi_con_cb_t);
					_LINE_DESP();
					break;
				case 'e':
					//wifi_station_disconnect();
				...
				case 'f':
					...
					os_printf("connect to wifi\r\n");
					user_esp_platform_set_token("0123456789012345678901234567890123456789");
					WIFI_Connect("miwifi3","123456789",NULL);
					_LINE_DESP();
					break;
				case 'g':
					//wifi_station_disconnect();
					...
					os_printf("connect to wifi\r\n");
					user_esp_platform_set_token("0123456789012345678901234567890123456789");
					WIFI_Connect("miwifi00","123456789",NULL);
					_LINE_DESP();
					break;
#endif
				case 'h':
